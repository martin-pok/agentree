...
function onboardingHtml() {
  ...
  const steps = [
    ...
    { done: Boolean(ext && ext.state !== 'missing'), label: 'Rozšíření pro Chrome', sub: 'Agenti z ChatGPT, Gemini a Claude.ai v přehledu. Zadání se do nich vloží samo.', cta: `<button class="btn btn--sm" type="button" data-go-extension>${ext?.repair ? 'Spárovat znovu' : 'Nainstalovat'}</button>` },
