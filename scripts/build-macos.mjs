...
const infoTemplate = await fs.readFile(path.join(root, 'desktop/Info.plist'), 'utf8');
await fs.writeFile(path.join(app, 'Contents/Info.plist'), infoTemplate.replaceAll('__VERSION__', version));
