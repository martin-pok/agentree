...
nabízejí — bez ohledu na to, co z toho už Agentree implementuje. Fakta jsou ověřená v oficiální
...
- **Implementováno v Agentree** — odkaz na `src/connectors/cloud-billing.js`, jinak jde jen o audit bez kódu.
...
historii chatů. Tohle rozlišení určuje, komu Agentree může nabídnout automatické napojení a komu jen ruční zápis.
